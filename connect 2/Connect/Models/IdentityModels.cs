...
namespace Connect.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public System.Data.Entity.DbSet<Phrase> Phrases { get; set; }
        ...
        {
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<ApplicationDbContext, Connect.Migrations.Configuration>("DefaultConnection"));
        }
